...
return [(function (){var pred__12377 = cljs.core.instance_QMARK_;
var expr__12378 = reactive_val;
if(cljs.core.truth_((pred__12377.cljs$core$IFn$_invoke$arity$2 ? pred__12377.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__12378) : pred__12377.call(null,reagent.ratom.RAtom,expr__12378)))){
return "ra";
} else {
if(cljs.core.truth_((pred__12377.cljs$core$IFn$_invoke$arity$2 ? pred__12377.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__12378) : pred__12377.call(null,reagent.ratom.RCursor,expr__12378)))){
return "rc";
} else {
if(cljs.core.truth_((pred__12377.cljs$core$IFn$_invoke$arity$2 ? pred__12377.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__12378) : pred__12377.call(null,reagent.ratom.Reaction,expr__12378)))){
return "rx";
} else {
if(cljs.core.truth_((pred__12377.cljs$core$IFn$_invoke$arity$2 ? pred__12377.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__12378) : pred__12377.call(null,reagent.ratom.Track,expr__12378)))){
return "tr";
} else {
return "other";
}
