...
routes.components.product.items = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 5, [cljs.core.cst$kw$title,"Producer App",cljs.core.cst$kw$desc,"This application is made to assist the drivers and collect data.",cljs.core.cst$kw$img,"img/producer.jpg",cljs.core.cst$kw$icon,"bus",cljs.core.cst$kw$list,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Collects data for services (trial)","Drivers can send notifications to traffic control (trial)","Shows speed limits warnings","Displays route for drivers"], null)], null),new cljs.core.PersistentArrayMap(null, 5, [cljs.core.cst$kw$title,"Admin Panel",cljs.core.cst$kw$desc,"You have full control over the flow of information in the system.",cljs.core.cst$kw$img,"img/admin.jpg",cljs.core.cst$kw$icon,"desktop",cljs.core.cst$kw$list,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Monitoring of buses in real-time (trial)","Easily access information using advanced search","Shows live stats of active buses","Shows details about the drivers"], null)], null),new cljs.core.PersistentArrayMap(null, 5, [cljs.core.cst$kw$title,"Client App",cljs.core.cst$kw$desc,"Your clients can enjoy perks of your servies more fully.",cljs.core.cst$kw$img,"img/client.jpg",cljs.core.cst$kw$icon,"mobile alternate",cljs.core.cst$kw$list,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Info for desired bus in real-time (trial)","Shows routes for buses with info about future stops (trial)","Best route for desired destination","Buy tickets online"], null)], null),new cljs.core.PersistentArrayMap(null, 5, [cljs.core.cst$kw$title,"Data Overview",cljs.core.cst$kw$desc,"Have unique insight for your business based on data.",cljs.core.cst$kw$img,"img/expense.png",cljs.core.cst$kw$icon,"chart area",cljs.core.cst$kw$list,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Have track record for each bus driver","Display information for each bus over period of time","Show estimated fuel consumption","Show customer usage patterns "], null)], null)], null);
...
routes.components.product.handle_click = (function routes$components$product$handle_click(p__10050){
var map__10051 = p__10050;
var map__10051__$1 = (((((!((map__10051 == null))))?(((((map__10051.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10051.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__10051):map__10051);
var index = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10051__$1,cljs.core.cst$kw$index);
...
});})(map__10054,map__10054__$1,title,desc,img,icon,list))
...
routes.components.product.products = (function routes$components$product$products(pc_QMARK_){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$_GT_,routes.components.product.global$module$cljsjs$semantic_ui_react.Grid.Row,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$class_DASH_name,"no-border segment-bg"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$_GT_,routes.components.product.global$module$cljsjs$semantic_ui_react.Grid.Column,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$_GT_,routes.components.product.global$module$cljsjs$semantic_ui_react.Container,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$text_DASH_align,cljs.core.cst$kw$center], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$anchor_DASH_offset,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$id,"what",cljs.core.cst$kw$style,(cljs.core.truth_(pc_QMARK_)?new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$top,cljs.core.cst$kw$_DASH_24vh], null):null)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$h2,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$color,cljs.core.cst$kw$white], null)], null),"WHAT WE OFFER"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [routes.components.product.product_item,cljs.core.get.cljs$core$IFn$_invoke$arity$2(routes.components.product.items,cljs.core.deref(routes.components.product.screen_index))], null)], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$_GT_,routes.components.product.global$module$cljsjs$semantic_ui_react.Menu,new cljs.core.PersistentArrayMap(null, 6, [cljs.core.cst$kw$inverted,true,cljs.core.cst$kw$pointing,true,cljs.core.cst$kw$secondary,true,cljs.core.cst$kw$fluid,true,cljs.core.cst$kw$widths,(4),cljs.core.cst$kw$size,cljs.core.cst$kw$massive], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$_GT_,routes.components.product.global$module$cljsjs$semantic_ui_react.Menu.Item,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$name,cljs.core.cst$kw$admin,cljs.core.cst$kw$active,cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$screen.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(routes.components.product.active_screen)),cljs.core.cst$kw$producer),cljs.core.cst$kw$on_DASH_click,(function (){
...
})], null),"Data Overview"], null)], null)], null)], null)], null);
});
