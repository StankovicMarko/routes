...
var G__12034 = o;
(G__12034[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__12038 = o;
(G__12038[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
while (G__12040__i < G__12040__a.length) {G__12040__a[G__12040__i] = arguments[G__12040__i + 0]; ++G__12040__i;}
  args = new cljs.core.IndexedSeq(G__12040__a,0,null);
} 
...
var G__12043 = props;
var G__12043__$1 = ((((!((id == null))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12043,cljs.core.cst$kw$id,id):G__12043);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12043__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__12044){
...
var props = map__12045__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12045__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__12045,map__12045__$1,props,class$){
return (function (c){
...
});})(map__12045,map__12045__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__12047){
var map__12048 = p__12047;
var map__12048__$1 = ((((!((map__12048 == null)))?(((((map__12048.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__12048.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__12048):map__12048);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12048__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__12048,map__12048__$1,on_write){
return (function (){
...
});})(node_value,map__12048,map__12048__$1,on_write))
);
} else {
...
var G__12051 = jsprops;
(G__12051["defaultValue"] = value);

(G__12051["onChange"] = ((function (G__12051,v,value,on_change){
return (function (p1__12050_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12050_SHARP_);
});})(G__12051,v,value,on_change))
);
...
var vec__12054 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12054,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12054,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12054,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___12058 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___12058 == null)){
} else {
var key_12059 = temp__5461__auto___12058;
(jsprops["key"] = key_12059);
}
...
var temp__5461__auto___12060 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___12060 == null)){
} else {
var key_12061 = temp__5461__auto___12060;
reagent.impl.template.oset(jsprops,"key",key_12061);
}
...
var G__12062 = reagent.impl.template.__GT_NativeWrapper();
(G__12062["name"] = c);
...
var G__12063 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12063) : reagent.impl.template.as_element.call(null,G__12063));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12066){
var G__12067 = cljs.core.first(seq12066);
var seq12066__$1 = cljs.core.next(seq12066);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12067,seq12066__$1);
});
...
break;
default:
var G__12073 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__12073;
continue;
...
var n__4408__auto___12075 = a.length;
var i_12076 = (0);
while(true){
if((i_12076 < n__4408__auto___12075)){
(a[i_12076] = reagent.impl.template.as_element((a[i_12076])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4408__auto___12078 = a.length;
var i_12079 = (0);
while(true){
if((i_12079 < n__4408__auto___12078)){
var val_12080 = (a[i_12079]);
if(((cljs.core.vector_QMARK_(val_12080)) && ((reagent.impl.template.key_from_vec(val_12080) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_12079] = reagent.impl.template.as_element(val_12080));

var G__12081 = (i_12079 + (1));
i_12079 = G__12081;
continue;
} else {
}
...
var ctx = ({});
var vec__12082 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12082,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12082,(1),null);
...
var G__12085 = (cljs.core.count(argv) - first_child);
switch (G__12085) {
case (0):
...
case (1):
var G__12086 = comp;
var G__12087 = jsprops;
var G__12088 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__12086,G__12087,G__12088) : reagent.impl.template.global$module$react.createElement.call(null,G__12086,G__12087,G__12088));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__12085){
