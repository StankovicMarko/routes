...
var G__12203 = o;
(G__12203[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__12207 = o;
(G__12207[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__12212 = props;
var G__12212__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12212,cljs.core.cst$kw$id,id):G__12212);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12212__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__12213){
...
var props = map__12214__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12214__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__12214,map__12214__$1,props,class$){
return (function (c){
...
});})(map__12214,map__12214__$1,props,class$))
,class$)));
} else {
return props;
}
...
return reagent.impl.batching.do_after_render(((function (node_value,map__12217,map__12217__$1,on_write){
return (function (){
...
});})(node_value,map__12217,map__12217__$1,on_write))
);
} else {
...
var G__12220 = jsprops;
(G__12220["defaultValue"] = value);

(G__12220["onChange"] = ((function (G__12220,v,value,on_change){
return (function (p1__12219_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12219_SHARP_);
});})(G__12220,v,value,on_change))
);
...
var vec__12223 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12223,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12223,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12223,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___12227 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___12227 == null)){
} else {
var key_12228 = temp__5739__auto___12227;
(jsprops["key"] = key_12228);
}
...
var temp__5739__auto___12229 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___12229 == null)){
} else {
var key_12230 = temp__5739__auto___12229;
reagent.impl.template.oset(jsprops,"key",key_12230);
}
...
var G__12231 = reagent.impl.template.__GT_NativeWrapper();
(G__12231["name"] = c);
...
var G__12232 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12232) : reagent.impl.template.as_element.call(null,G__12232));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12236){
...
var n__4607__auto___12245 = a.length;
var i_12246 = (0);
while(true){
if((i_12246 < n__4607__auto___12245)){
(a[i_12246] = reagent.impl.template.as_element((a[i_12246])));

var G__12247 = (i_12246 + (1));
i_12246 = G__12247;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___12248 = a.length;
var i_12249 = (0);
while(true){
if((i_12249 < n__4607__auto___12248)){
var val_12250 = (a[i_12249]);
if(((cljs.core.vector_QMARK_(val_12250)) && ((reagent.impl.template.key_from_vec(val_12250) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_12249] = reagent.impl.template.as_element(val_12250));
...
var ctx = ({});
var vec__12252 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12252,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12252,(1),null);
...
var G__12255 = (cljs.core.count(argv) - first_child);
switch (G__12255) {
case (0):
...
case (1):
var G__12256 = comp;
var G__12257 = jsprops;
var G__12258 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__12256,G__12257,G__12258) : reagent.impl.template.global$module$react.createElement.call(null,G__12256,G__12257,G__12258));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__12255){
