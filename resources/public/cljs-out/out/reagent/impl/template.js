...
var G__11369 = o;
(G__11369[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__11373 = o;
(G__11373[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__11375__i < G__11375__a.length) {G__11375__a[G__11375__i] = arguments[G__11375__i + 0]; ++G__11375__i;}
  args = new cljs.core.IndexedSeq(G__11375__a,0,null);
} 
...
var G__11378 = props;
var G__11378__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__11378,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__11378);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__11378__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__11379){
...
var props = map__11380__$1;
var class$ = cljs.core.get.call(null,map__11380__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__11380,map__11380__$1,props,class$){
return (function (c){
...
});})(map__11380,map__11380__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__11382){
...
var on_write = cljs.core.get.call(null,map__11383__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__11383,map__11383__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__11383,map__11383__$1,on_write))
);
} else {
...
var G__11386 = jsprops;
(G__11386["defaultValue"] = value);

(G__11386["onChange"] = ((function (G__11386,v,value,on_change){
return (function (p1__11385_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__11385_SHARP_);
});})(G__11386,v,value,on_change))
);
...
var vec__11389 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__11389,(0),null);
var id = cljs.core.nth.call(null,vec__11389,(1),null);
var class$ = cljs.core.nth.call(null,vec__11389,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___11393 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___11393 == null)){
} else {
var key_11394 = temp__5461__auto___11393;
(jsprops["key"] = key_11394);
}
...
var temp__5461__auto___11395 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___11395 == null)){
} else {
var key_11396 = temp__5461__auto___11395;
reagent.impl.template.oset.call(null,jsprops,"key",key_11396);
}
...
var G__11397 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__11397["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq11400){
...
break;
default:
var G__11407 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__11407;
continue;
...
var n__4408__auto___11409 = a.length;
var i_11410 = (0);
while(true){
if((i_11410 < n__4408__auto___11409)){
(a[i_11410] = reagent.impl.template.as_element.call(null,(a[i_11410])));
...
var a = cljs.core.into_array.call(null,s);
var n__4408__auto___11412 = a.length;
var i_11413 = (0);
while(true){
if((i_11413 < n__4408__auto___11412)){
var val_11414 = (a[i_11413]);
if(((cljs.core.vector_QMARK_.call(null,val_11414)) && ((reagent.impl.template.key_from_vec.call(null,val_11414) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_11413] = reagent.impl.template.as_element.call(null,val_11414));

var G__11415 = (i_11413 + (1));
i_11413 = G__11415;
continue;
} else {
}
...
var ctx = ({});
var vec__11416 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__11416,(0),null);
var derefed = cljs.core.nth.call(null,vec__11416,(1),null);
...
var G__11419 = (cljs.core.count.call(null,argv) - first_child);
switch (G__11419) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__11419){
