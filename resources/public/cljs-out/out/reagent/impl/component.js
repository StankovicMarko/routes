...
if((i < len)){
var k = (ks[i]);
var G__11984 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__11985 = (i + (1));
m = G__11984;
i = G__11985;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__11986 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__11986) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__11986));
})());
} else {
var v = temp__5459__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__11988 = c;
var G__11988__$1 = (((G__11988 == null))?null:G__11988.prototype);
if((G__11988__$1 == null)){
return null;
} else {
return (G__11988__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__11990 = c;
var G__11990__$1 = (((G__11990 == null))?null:G__11990.prototype);
if((G__11990__$1 == null)){
return null;
} else {
return (G__11990__$1["render"]);
}
})() == null))));
});
...
return (function() { 
var G__11994__delegate = function (args){
var G__11992 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__11992) : reagent.impl.component.as_element.call(null,G__11992));
};
...
while (G__11995__i < G__11995__a.length) {G__11995__a[G__11995__i] = arguments[G__11995__i + 0]; ++G__11995__i;}
  args = new cljs.core.IndexedSeq(G__11995__a,0,null);
} 
return G__11994__delegate.call(this,args);};
G__11994.cljs$lang$maxFixedArity = 0;
G__11994.cljs$lang$applyTo = (function (arglist__11996){
var args = cljs.core.seq(arglist__11996);
return G__11994__delegate(args);
});
...
var _STAR_current_component_STAR_11998 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_11998;
}});
...
return ((function (G__11999,G__11999__$1){
...
var c = this;
var G__12004_12006 = (c["cljsRatom"]);
if((G__12004_12006 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12004_12006);
}
...
var renders_12008 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_12009 = cljs.core.first(cljs.core.vals(renders_12008));
if((cljs.core.count(renders_12008) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_12008))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_12009)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_12009], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__12007 = name;
switch (G__12007) {
case "":
...
var G__12012 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__12012) : reagent.impl.component.global$module$create_react_class.call(null,G__12012));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__12013 = fiber;
var G__12013__$1 = (((G__12013 == null))?null:(G__12013["type"]));
if((G__12013__$1 == null)){
return null;
} else {
return (G__12013__$1["displayName"]);
}
})();
var parent = (function (){var G__12014 = fiber;
if((G__12014 == null)){
return null;
} else {
return (G__12014["return"]);
}
})();
var path = (function (){var G__12015 = parent;
var G__12015__$1 = (((G__12015 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__12015) : reagent.impl.component.fiber_component_path.call(null,G__12015)));
if((G__12015__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12015__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3949__auto__ = (function (){var G__12017 = c;
if((G__12017 == null)){
return null;
} else {
return (G__12017["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__12018._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3949__auto__ = (function (){var G__12020 = c;
if((G__12020 == null)){
return null;
} else {
return (G__12020["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var or__3949__auto____$1 = (function (){var G__12022 = c;
if((G__12022 == null)){
return null;
} else {
return G__12022._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3949__auto__ = (function (){var G__12024 = instance;
if((G__12024 == null)){
return null;
} else {
return (G__12024["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var G__12025 = instance;
if((G__12025 == null)){
return null;
} else {
return G__12025._currentElement;
}
}
})();
var name = (function (){var G__12026 = elem;
var G__12026__$1 = (((G__12026 == null))?null:(G__12026["type"]));
...
var owner = (function (){var or__3949__auto__ = (function (){var G__12028 = elem;
if((G__12028 == null)){
return null;
} else {
return (G__12028["_owner"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__12029._owner;
}
}
})();
var path = (function (){var G__12030 = owner;
var G__12030__$1 = (((G__12030 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__12030) : reagent.impl.component.component_path.call(null,G__12030)));
if((G__12030__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12030__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__12031 = c;
var G__12031__$1 = (((G__12031 == null))?null:G__12031.constructor);
if((G__12031__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__12031__$1);
}
}
})();
