...
if((i < len)){
var k = (ks[i]);
var G__12135 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__12136 = (i + (1));
m = G__12135;
i = G__12136;
continue;
...
var temp__5737__auto__ = (p["argv"]);
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__12137 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__12137) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__12137));
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__12139 = c;
var G__12139__$1 = (((G__12139 == null))?null:G__12139.prototype);
if((G__12139__$1 == null)){
return null;
} else {
return (G__12139__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__12141 = c;
var G__12141__$1 = (((G__12141 == null))?null:G__12141.prototype);
if((G__12141__$1 == null)){
return null;
} else {
return (G__12141__$1["render"]);
}
})() == null)))));
});
...
var G__12143 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__12143) : reagent.impl.component.as_element.call(null,G__12143));
};
...
var _STAR_current_component_STAR__orig_val__12149 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__12150 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__12150;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__12149;
}});
...
return ((function (G__12151,G__12151__$1){
...
var c = this;
var G__12156_12158 = (c["cljsRatom"]);
if((G__12156_12158 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12156_12158);
}
...
var renders_12160 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_12161 = cljs.core.first(cljs.core.vals(renders_12160));
if((cljs.core.count(renders_12160) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_12160))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_12161)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_12161], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__12159 = name;
switch (G__12159) {
case "":
...
var G__12164 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__12164) : reagent.impl.component.global$module$create_react_class.call(null,G__12164));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__12165 = fiber;
var G__12165__$1 = (((G__12165 == null))?null:(G__12165["type"]));
if((G__12165__$1 == null)){
return null;
} else {
return (G__12165__$1["displayName"]);
}
})();
var parent = (function (){var G__12166 = fiber;
if((G__12166 == null)){
return null;
} else {
return (G__12166["return"]);
}
})();
var path = (function (){var G__12167 = parent;
var G__12167__$1 = (((G__12167 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__12167) : reagent.impl.component.fiber_component_path.call(null,G__12167)));
if((G__12167__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12167__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4131__auto__ = (function (){var G__12169 = c;
if((G__12169 == null)){
return null;
} else {
return (G__12169["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__12170._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__12172 = c;
if((G__12172 == null)){
return null;
} else {
return (G__12172["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__12174 = c;
if((G__12174 == null)){
return null;
} else {
...
var elem = (function (){var or__4131__auto__ = (function (){var G__12176 = instance;
if((G__12176 == null)){
return null;
} else {
return (G__12176["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__12177 = instance;
if((G__12177 == null)){
return null;
} else {
return G__12177._currentElement;
}
}
})();
var name = (function (){var G__12178 = elem;
var G__12178__$1 = (((G__12178 == null))?null:(G__12178["type"]));
if((G__12178__$1 == null)){
return null;
} else {
return (G__12178__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__12180 = elem;
if((G__12180 == null)){
return null;
} else {
return (G__12180["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__12181._owner;
}
}
})();
var path = (function (){var G__12182 = owner;
var G__12182__$1 = (((G__12182 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__12182) : reagent.impl.component.component_path.call(null,G__12182)));
if((G__12182__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12182__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__12183 = c;
var G__12183__$1 = (((G__12183 == null))?null:G__12183.constructor);
if((G__12183__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__12183__$1);
}
}
})();
